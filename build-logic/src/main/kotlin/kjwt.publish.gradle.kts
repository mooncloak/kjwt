...
fun MavenPublication.mavenCentralPom() {
    pom {
        name.set("kjwt")
        description.set("Kotlin multi-platform JSON Web Token (JWT/JWS) library.")
        url.set("https://github.com/mooncloak/kjwt")
        ...
        issueManagement {
            url.set("https://github.com/mooncloak/kjwt/issues")
        ...
        developers {
            developer {
                ...
                roles.set(setOf("Primary kjwt developer. 💪"))
            }
        }

        scm {
            connection.set("https://github.com/mooncloak/kjwt.git")
            developerConnection.set("https://github.com/mooncloak/kjwt.git")
            url.set("https://github.com/mooncloak/kjwt")
        }
    }
}
